...
import type { ProductAttributeListFilterDto, ProductAttributeValueDto, addUpdateProductAttributeDto } from '../../catalog/products/attributes/models';
import type { CreateUpdateProductDto, ProductDto, ProductInListDto } from '../../catalog/products/models';
import type { ProductListFilterDto } from '../../models';
...
export class ProductsService {
  ...
  getListFilterAttribute = (input: ProductAttributeListFilterDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, PagedResultDto<ProductAttributeValueDto>>({
      method: 'GET',
      url: '/api/app/products/filter-attribute',
  ...
  addAttibute = (input: addUpdateProductAttributeDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, ProductAttributeValueDto>({
      method: 'POST',
      url: '/api/app/products/add-attibute',
      body: input,
    },
    { apiName: this.apiName,...config });
  ...
  removeAttribute = (attributeId: string, id: string, config?: Partial<Rest.Config>) =>
    this.restService.request<any, void>({
      method: 'DELETE',
      url: `/api/app/products/${id}/remove-attribute/${attributeId}`,
    },
    { apiName: this.apiName,...config });
  

  updateAttibute = (id: string, input: addUpdateProductAttributeDto, config?: Partial<Rest.Config>) =>
    this.restService.request<any, ProductAttributeValueDto>({
      method: 'PUT',
      url: `/api/app/products/${id}/update-attibute`,
      body: input,
    },
    { apiName: this.apiName,...config });
