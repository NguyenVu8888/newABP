...
import { ACCESS_TOKEN, REFRESH_TOKEN } from '../constants/key.contants';
...
export class AuthService {
  ...
  public refreshToken(refreshTokenGet: string): Observable<LoginResponseDto> {
    var body = {
      client_id: environment.oAuthConfig.clientId,
      client_secret: environment.oAuthConfig.dummyClientSecret,
      grant_type: 'refresh_token',
      refresh_token: refreshTokenGet,
    };
