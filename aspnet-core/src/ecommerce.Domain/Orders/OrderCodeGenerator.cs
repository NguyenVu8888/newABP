...
namespace ecommerce.Orders
{
    public class OrderCodeGenerator : ITransientDependency
    {
        ...
        public async Task<string> GenerateAsync()
        {
            ...
            {
                identitySetting = await _identitySettingRepository.InsertAsync(new IdentitySetting(ecommerceConsts.OrderIdentitySettingId, "Sản phẩm", ecommerceConsts.OrderIdentitySettingPrefix, 1, 1));
