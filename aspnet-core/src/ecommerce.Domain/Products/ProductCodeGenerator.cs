...
namespace ecommerce.Products
{
    public class ProductCodeGenerator : ITransientDependency
    {
        ...
        public async Task<string> GenerateAsync()
        {
            ...
            {
                identitySetting = await _identitySettingRepository.InsertAsync(new IdentitySetting(ecommerceConsts.ProductIdentitySettingId, "Sản phẩm",
                    ecommerceConsts.ProductIdentitySettingPrefix, 1, 1));
