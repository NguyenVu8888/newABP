...
using ecommerce.Configurations.IdentitySettingConfiguration;
    ...
    ITenantManagementDbContext
{
    ...
    public DbSet<InvenoryTicket> InvenoryTickets { get; set; }
    ...
    public DbSet<PromotionCategory> PromotionCategorys { get; set; }
